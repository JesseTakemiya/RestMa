...
class TablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table" do
    assert_difference("Table.count") do
      post tables_url, params: { table: { capacity: @table.capacity, reservation_id: @table.reservation_id, status: @table.status, table_number: @table.table_number } }
    end
  ...
  test "should update table" do
    patch table_url(@table), params: { table: { capacity: @table.capacity, reservation_id: @table.reservation_id, status: @table.status, table_number: @table.table_number } }
