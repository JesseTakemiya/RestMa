...
class CouponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coupon" do
    assert_difference("Coupon.count") do
      post coupons_url, params: { coupon: { active: @coupon.active, code: @coupon.code, discount_amount: @coupon.discount_amount, expiration_date: @coupon.expiration_date, start_date: @coupon.start_date, usage_limit: @coupon.usage_limit } }
    end
  ...
  test "should update coupon" do
    patch coupon_url(@coupon), params: { coupon: { active: @coupon.active, code: @coupon.code, discount_amount: @coupon.discount_amount, expiration_date: @coupon.expiration_date, start_date: @coupon.start_date, usage_limit: @coupon.usage_limit } }
